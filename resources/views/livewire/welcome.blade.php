...
{{--     @if(!empty($resultados) && request()->is('pesquisa'))
    ...
    <div id="teste"class="container mt-1 mb-1">
        ...
        <div class="item">
            <a href="{{ route('filmes.show', ['filmeId' => $filme['id']]) }}" wire:navigate>
    ...
    @endforeach
      ...
      <div class="item">
                  <a href="{{ route('series.show', ['serieId' => $serie['id']]) }}"  wire:navigate>
      ...
      <div class="item">
      <a href="{{ route('filmes.show', ['filmeId' => $documentario['id']]) }}"  wire:navigate>
    ...
    <div class="container">
        ...
        <div class="item">
            <a href="{{ route('series.show', ['serieId' => $anime['id']]) }}" wire:navigate>
