...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
       ...
       <header>
            ...
            <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <a href="/"  wire:navigate.hover>Home
                </a>
            </li>
            @guest
            <li class="nav-item">
            ...
            @endguest
                ...
                <li class="nav-item">
                    ...
                    <a href="/dashboard"  wire:navigate>Meus Favoritos
                    </a>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <a href="/historico"  wire:navigate>Histórico
                </a>
            </li>
    ...
    <script src="/js/scriptsa.js" defer></script>
