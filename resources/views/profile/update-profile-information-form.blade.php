...
<x-slot name="description" >
    {{ __('Atualize suas informações e seu e-mail') }}
</x-slot>

    <x-slot name="form" style="background-color: rgb(15,15,15);">
        <!-- Profile Photo -->
...
<div class="mt-2" x-show="photoPreview" style="display: none;" id="cropper-container">
